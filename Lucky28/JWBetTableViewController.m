...
@property (nonatomic, strong) NSDictionary *willOpen;
...
- (NSDictionary *)willOpen{
    if (!_willOpen) {
        _willOpen =[NSDictionary dictionary];
    }
    return _willOpen;
}
- (NSArray *)BetData{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 1) {
        ...
        [self startWithTime:differTime Time1:cell.Time1 Time2:cell.Time2 Time3:cell.time3 Time4:cell.Time4];
        NSLog(@"----------------+%ld" ,differTime );
 ...
 *倒计时
 */
- (void)startWithTime:(NSInteger)timeLine Time1:(UILabel *)time1 Time2:(UILabel *)time2 Time3:(UILabel *)time3 Time4:(UILabel *)time4 {
    ...
    dispatch_source_set_event_handler(_timer, ^{
        ...
        if (timeOut <= 0) {
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                time1.textColor =[UIColor greenColor];
                time2.textColor =[UIColor greenColor];
                time3.textColor =[UIColor greenColor];
                time4.textColor =[UIColor greenColor];
